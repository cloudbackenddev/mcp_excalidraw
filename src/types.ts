...
export interface InitialElementsMessage extends StreamMessage {
  type: 'initial_elements';
  elements: ServerElement[];
}

export interface ElementCreatedMessage extends StreamMessage {
  type: 'element_created';
  element: ServerElement;
}

export interface ElementUpdatedMessage extends StreamMessage {
  type: 'element_updated';
  element: ServerElement;
}

export interface ElementDeletedMessage extends StreamMessage {
  type: 'element_deleted';
  elementId: string;
}

export interface BatchCreatedMessage extends StreamMessage {
  type: 'elements_batch_created';
  elements: ServerElement[];
}

export interface SyncStatusMessage extends StreamMessage {
  type: 'sync_status';
  elementCount: number;
  timestamp: string;
}

export interface MermaidConvertMessage extends StreamMessage {
...
export interface CanvasClearedMessage extends StreamMessage {
  type: 'canvas_cleared';
  timestamp: string;
}

// Image export types
export interface ExportImageRequestMessage extends StreamMessage {
...
export interface SetViewportMessage extends StreamMessage {
  type: 'set_viewport';
  requestId: string;
